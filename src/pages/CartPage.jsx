      ...
      {items.length === 0 ? (
        ...
        <div className="grid lg:grid-cols-12 gap-8">
                  ...
                  <div className="flex justify-between items-start gap-4">
                    <div>
                      ...
                      <div className="mt-1 text-xs text-gray-600 space-x-2">
                        {item.variant && <span>Color: {item.variantLabel || item.variant}</span>}
          ...
          <aside className="lg:col-span-4 border border-gray-200 rounded-md p-5 h-fit">
            ...
            <button onClick={clear} className="mt-3 w-full text-xs text-gray-500 hover:text-gray-900 underline">Clear cart</button>
