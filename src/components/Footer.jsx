...
export default function Footer() {
  ...
  const addressText = footerContact.address || 'Your store address'
  const phoneText = footerContact.phone || 'Your phone number'
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12">
            ...
            <div className="mt-4 space-y-3 text-sm text-gray-700 font-medium">
              ...
              <div className="flex items-center gap-3">
                ...
                <a
                  ...
                  href={phoneText && phoneText !== 'Your phone number' ? `tel:${String(phoneText).replace(/\s+/g, '')}` : undefined}
                >
                  {phoneText}
                </a>
              </div>
          ...
          <div className="lg:flex lg:justify-start">
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-y-8 gap-x-16 w-full lg:max-w-3xl">
              <Section title="Help">
                <li><Link to="#" className="text-sm text-gray-700 hover:underline">Contact us</Link></li>
